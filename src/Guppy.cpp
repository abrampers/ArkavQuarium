...
void Guppy::updateProgress() {
	...
	if(this->getHungry() && (this->getState() != State::eatingRight && this->getState() != State::eatingLeft) && (this->nearest_pellet != nullptr) && distanceToPellet(this->nearest_pellet) < (2 * guppyEatRadius)) {
