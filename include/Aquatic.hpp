...
//! Abstract Class Aquatic. Represents all object in Aquarium such as Piranha,
//! Guppy, Snail, Pellet, and Coin.
class Aquatic {
 private:
  Aquarium* aquarium;
  double x, y;
  ...
  */
  ...
  //! Getter for aquarium.
  /*!
      \return Aquarium *aquarium Pointer to the Aquarium that contains the
     object.
  */
  ...
  */
  ...
  //! Getter for state.
  /*!
      \return State state The current state of the Aquatic : movingRight,
     movingLeft, turningRight, turningLeft, stillLeft, stillRight, deadLeft,
     deadRight
  */
  State getState();
  ...
  */
  ...
  /*!
      \return double last_progress_time The last time the object progress time
     was updated.
  */
  ...
  /* All aquatic entities can move. Returns pair of <vx, vy> where vx is
   * velocity in X direction and vy is velocity in y direction.*/
